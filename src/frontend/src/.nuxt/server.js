...
import Vue from 'vue'
import NuxtLink from './components/nuxt-link.server.js.js'; // should be included after ./index.js
import { createApp, NuxtError } from './index.js.js'
import middleware from './middleware.js.js'
import { applyAsyncData, getMatchedComponents, middlewareSeries, promisify, sanitizeComponent } from './utils.js.js'
